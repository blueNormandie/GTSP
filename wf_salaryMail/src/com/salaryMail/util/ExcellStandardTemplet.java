...
public class ExcellStandardTemplet {
...
//				(byte) 207, (byte) 163);
	...
	public static float getExcelCellAutoHeight2(String str, float fontCountInline) {
		float defaultRowHeight = 12.00f;// 每一行的高度指定
		float defaultCount = 0.00f;
		for (int i = 0; i < str.length(); i++) {
			float ff = getregex(str.substring(i, i + 1));
	...
	public static void main(String[] args) {
		...
		sfscExcellPay(dealSalaryInfo, "D://workbook.xls","D://sfsc_logo.jpg", 0);
//		ExcellToPdf.saveAsPDF("D:\\workbook.xls", "D:\\workbook.pdf");
	}
}
